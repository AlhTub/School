...
public class LogIn extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtstudno, javax.swing.GroupLayout.DEFAULT_SIZE, 196, Short.MAX_VALUE)
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        if (txtstudno.getText().equals(" ")) {
            JOptionPane.showMessageDialog(null, "Input student number");
        }
        else if(pwfpass.getText().equals(" ")){
            JOptionPane.showMessageDialog(null, "Input password");
        }
        else if (txtstudno.getText().equals(SignUp.txtstudno.getText()) && pwfpass.getText().equals(SignUp.pwfrepass.getText())){
            TimeInOut main = new TimeInOut();
            ...
            JOptionPane.showMessageDialog(null, "Incorrect student number or password");
        }
